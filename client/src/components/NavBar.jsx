    ...
    <>
      <nav className='fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600'>
        <div className='max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4'>
          ...
          >
            <span className='self-center text-5xl font-semibold whitespace-nowrap font-secondary motion-preset-blur-right'>
              WAIS.
            </span>
          </Link>
          <div className='flex md:order-2 space-x-3 md:space-x-0'>
            <Link
              to='/login'
              className='text-forest-green bg-bright-green hover:bg-bright-green-hover font-extrabold rounded-2xl text-md px-5 py-2 md:py-1 text-center inline-block'
            >
              Get started
            </Link>
            <button
          ...
          <div
            ...
            id='navbar-sticky'
          >
            <ul className='flex flex-col p-4 md:p-0 mt-4 font-bold border rounded-lg md:space-x-1 space-y-2 md:space-y-px rtl:space-x-reverse md:flex-row md:mt-0 md:border-0'>
              <li>
                <a
                  href='#home'

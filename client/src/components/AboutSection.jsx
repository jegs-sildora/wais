...
export default function AboutSection() {
	return (
		...
		>
			...
			<div className="container px-6 py-16 lg:py-0 mx-auto intersect:motion-preset-fade intersect:motion-opacity-in-0 intersect:motion-translate-x-in-25 intersect:motion-ease-spring-smooth intersect:motion-preset-blur-right">
				...
				<div className="grid grid-cols-1 gap-8 mt-8 lg:mt-12 lg:grid-cols-2 lg:mx-auto lg:max-w-5xl md:grid-cols-2 ">
					...
					<div className="flex flex-col items-center p-6 space-y-3 text-center rounded-xl outline-4 outline-forest-green intersect-once intersect:motion-scale-in-[0.5] intersect:motion-opacity-in-[0%] intersect:motion-delay-900">
						...
						<p className="text-md ">
							...
							<span className="font-bold">WAIS!</span> Organize transactioMns,
